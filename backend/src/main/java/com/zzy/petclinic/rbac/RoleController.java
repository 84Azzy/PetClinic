...
public class RoleController {
  ...
  @PostMapping
  public ApiResponse<SysRole> create(@Valid @RequestBody RbacRequests.RoleSave r) {
    throw todo();
  }

  @PutMapping("/{id}")
  public ApiResponse<SysRole> update(
      @PathVariable Long id, @Valid @RequestBody RbacRequests.RoleSave r) {
    throw todo();
  }
  ...
  public ApiResponse<Void> permissions(
      @PathVariable Long id, @Valid @RequestBody RbacRequests.Ids r) {
    throw todo();
  }
