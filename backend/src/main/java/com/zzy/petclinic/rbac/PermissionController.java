...
public class PermissionController {
  ...
  @PostMapping
  public ApiResponse<SysPermission> create(@Valid @RequestBody RbacRequests.PermissionSave r) {
    throw todo();
  }

  @PutMapping("/{id}")
  public ApiResponse<SysPermission> update(
      @PathVariable Long id, @Valid @RequestBody RbacRequests.PermissionSave r) {
    throw todo();
  }
